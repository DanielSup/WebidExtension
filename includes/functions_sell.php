...
function addauction()
{
    ...
    foreach($countries as $id => $country){
        ...
        foreach($shipping_options as $shipping_method_id => $shipping_option){
...
function addShippingOption($country_index, $shipping_option_index, $shipping_options_to_select, $shipping_option_array){
    $shipping_option = "<div class='form-group col-md-12 dutchhide' id='country-definition-$country_index-shipping-option-$shipping_option_index'>";
    $shipping_option .= "<div class='form-group col-md-12 dutchhide'>";
    ...
    foreach($shipping_options_to_select as $shipping_option_id => $shipping_option_name) {
        $shipping_option_select .= "<option value='$shipping_option_id'>$shipping_option_name</option>";
    }
    $shipping_option_select .= "</select>";
    $shipping_option .= "<div>$shipping_option_select</div>";
    $shipping_option .= "</div>";
