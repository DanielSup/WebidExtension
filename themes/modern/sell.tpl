...
<!-- IF PAGE eq 0 -->
	...
	<!-- ENDIF -->
	<!-- IF ALL_COUNTRIES -->
					<div id="countries-shipping-definition">
						{SELECTED_COUNTRIES}
						<div id="country-definition-{FIRST_COUNTRY_ORDER_TO_SELECT}" class="form-group col-md-12 dutchhide">
							<label>Country where you want to deliver the item</label>
							<p>{ALL_COUNTRIES}</p>
						</div>
					</div>
	<!-- ENDIF -->
...
<!-- ELSEIF PAGE eq 2 -->
	...
	<!-- IF B_SHIPPING -->
						<!-- IF ALL_COUNTRIES -->
							<tr>
								<td valign="top" align="right"><b>Countries</b></td>
								<td>{ALL_COUNTRIES}</td>
							</tr>
						<!-- ENDIF -->
						<tr>
